...
export async function POST(request) {
  try {
    ...
    const mailOptionsClient = {
      ...
      subject:
        "Welcome to Holaxgroup – Your Account Has Been Successfully Created!",
      html: `
            ...
            <tr>
              <td style="padding: 40px">
                ...
                <p style="text-align: left; font-size: 16px">
                  We are excited to welcome you to the Holaxgroup community! Your account has been successfully created, and you are now part of a platform dedicated to providing top-notch business and marketing consulting services.
                </p>
                ...
                <p style="text-align: left; font-size: 16px">Thank you for choosing Holaxgroup. We look forward to supporting you on your business journey!</p>
