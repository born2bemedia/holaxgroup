                    ...
                    <div className="home-items__items">
                        <motion.div
                            ...
                            <div className="home-items__wrapper">
                                ...
                                <p className="home-items__label">Transforming Visions into Reality</p>
                        ...
                        <motion.div
                            ...
                            <div className="home-items__wrapper">
                                ...
                                <p className="home-items__label">Success Stories that Inspire</p>
                                <div className="home-items__text">
                        ...
                        <motion.div
                            ...
                            <div className="home-items__wrapper">
                                ...
                                <p className="home-items__label">Stay Ahead with the Latest Industry Trends</p>
                                <div className="home-items__text">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            variants={fadeInUp}
                            className="home-items__item _last"></motion.div>
                    </div>
                </div>
            </div>
        </section>
