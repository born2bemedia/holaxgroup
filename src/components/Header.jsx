            ...
            <div className={`header__menu ${menuOpened ? "_active" : ""}`}>
              <nav className="header__nav _container">
                <ul className="header__list">
                  <li className="header__item-menu"><Link href="/" onClick={closeMenu}>Home</Link></li>
                  <li
                    className={`header__item-menu _submenu ${submenuOpen["solutions"] || hoveredItem === "solutions" ? "_open" : ""}`}
                    onMouseEnter={() => handleMouseEnter("solutions")}
                    onMouseLeave={handleMouseLeave}
                  >
                    <div className="wrapper">
                      <Link href="/solutions" onClick={closeMenu}>Our Solutions</Link>
                    ...
                    <ul
                      className={`header__submenu ${submenuOpen["solutions"] || hoveredItem === "solutions" ? "_active" : ""}`}
                      style={{
                        maxHeight: submenuOpen["solutions"] || hoveredItem === "solutions" ? "1000px" : "0",
                        overflow: "hidden",
                        transition: "all 0.3s ease 0s",
                        paddingTop: submenuOpen["solutions"] || hoveredItem === "solutions" ? "10px" : "0",
                      }}
                    >
                      <li className="header__subitem">
                        <Link href="/business-consulting" onClick={closeMenu}>Business Consulting</Link>
                      </li>
                      <li className="header__subitem">
                        <Link href="/marketing-consulting" onClick={closeMenu}>Marketing Consulting</Link>
                      </li>
                    </ul>
                  </li>
                  <li
                  ...
                  >
                    ...
                    >
                      ...
                      <li className="header__subitem">
                        <Link href="/client-results" onClick={closeMenu}>Client Results</Link>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li
                    className={`header__item-menu _submenu ${submenuOpen["insights"] || hoveredItem === "insights" ? "_open" : ""}`}
                  ...
                  >
                    ...
                    <ul
                      className={`header__submenu ${submenuOpen["insights"] || hoveredItem === "insights" ? "_active" : ""}`}
                      style={{
                        maxHeight: submenuOpen["insights"] || hoveredItem === "insights" ? "1000px" : "0",
                        overflow: "hidden",
                        transition: "all 0.3s ease 0s",
                      }}
                    >
                      <li className="header__subitem">
                        <Link href="/industry-news" onClick={closeMenu}>Industry News</Link>
                      </li>
                      <li className="header__subitem">
                  ...
                  <li className="header__item-menu"><Link href="/careers" onClick={closeMenu}>Careers</Link></li>
            ...
            <nav className="header__nav">
              <ul className="header__account">
                <li className="header__account-item">
                  <Link href="#" className="header__account-link">Login</Link>
                </li>
                <li className="separator">|</li>
                <li className="header__account-item">
                  <Link href="#" className="header__account-link">Sign up</Link>
                </li>
              </ul>
            </nav>
          </div>
